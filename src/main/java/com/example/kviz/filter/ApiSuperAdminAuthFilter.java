...
@WebFilter(urlPatterns = {"/api/superadmin/*"})
public class ApiSuperAdminAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (!isSuperAdmin) {
            response.setContentType("application/json");
            response.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
            response.getWriter().write("{\"message\": \"You need to be a super admin to see this\"}");
            return;
        }
